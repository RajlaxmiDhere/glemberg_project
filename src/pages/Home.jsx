...
function Home() {
  ...
  const animateCount = (setter, target) => {
    let startTime = null;
    const duration = 2000; // Adjusted to 2 seconds for a better feel
          ...
          <div className="feature-section">
            <div className="feature-text animate-text">
              ...
              <p className="animate-line delay-4">
                From development to delivery, our focus remains on safety, consistency, and real-world clinical reliability.
              </p>
              <NavLink to="/about" className="feature-btn animate-line delay-5">Learn More</NavLink>
            </div>

            <div className="feature-image">
              {/* ✅ Replaced placeholder div with an actual image */}
              <img src={featureImg} alt="Medical Science and Care" className="feature-main-img" />
            </div>
          </div>
