...
<div className="credentials-section">
  <div className="credentials-flex-container">
    
    {/* Left Logo: FSSAI */}
    <div className="side-accreditation">
      <img 
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Fssai_logo.png/640px-Fssai_logo.png" 
        alt="FSSAI Logo" 
        className="colored-logo fssai" 
      />
    </div>
    ...
    <div className="side-accreditation">
      <img 
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/WHO_GMP_Logo.png/640px-WHO_GMP_Logo.png" 
        alt="WHO-GMP Logo" 
        className="colored-logo gmp" 
      />
    </div>
