        ...
        <div className="below-hero-inner">
          ...
          <div className={`feature-section ${isVisible ? "is-visible" : "is-hidden"}`} ref={featureRef}>
            <div className="feature-text animate-text">
              ...
              <NavLink to="/about" className={`feature-btn animate-line ${isVisible ? "delay-5" : ""}`}>Learn More</NavLink>
            </div>
          ...
          <div className="category-grid">
            <div className="category-card orange">
              <div className="category-image"><img src={generalImg} alt="General" /></div>
            ...
            <div className="category-card teal">
              <div className="category-image"><img src={orthoImg} alt="Ortho" /></div>
              <div className="category-info">
                <h3>Ortho Care</h3>
            ...
            <div className="category-card blue-light">
              <div className="category-image"><img src={dermaImg} alt="Derma" /></div>
              <div className="category-info">
                <h3>Derma Care</h3>
